...
public class ListJoinedEventsPresenter_Tests {
    List<Event> mEvents;
    ...
    @Mock
    ListJoinedEventsContracts.View mockView;

    private ListJoinedEventsPresenter mPresenter;
    ...
    public void setupTest() {
        ...
        when(mockRepository.getJoinedEvents(mUser.getUid()))
                .thenReturn(Observable.just(mEvents));

        mPresenter = new ListJoinedEventsPresenter(mockAuthProvider, mockRepository, mScheduleProvider);
